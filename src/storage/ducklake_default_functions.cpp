...
static const DefaultTableMacro ducklake_table_macros[] = {
	...
	{DEFAULT_SCHEMA, "merge_branch", {"source", nullptr}, {{"target", "NULL"}, {"dry_run", "false"}, {nullptr, nullptr}},  "FROM ducklake_merge_branch({CATALOG}, source, target => target, dry_run => dry_run)"},
