...
void DuckLakeInitializer::LoadExistingDuckLake(DuckLakeTransaction &transaction) {
	...
	for (auto &tag : metadata.tags) {
		if (tag.key == "version") {
			...
			if (catalog_version == DuckLakeVersion::V1_1_DEV_2 && options.automatic_migration) {
				metadata_manager.MigrateV11(true);
			}
			if (catalog_version == DuckLakeVersion::V1_1_DEV_3 && options.automatic_migration) {
				metadata_manager.MigrateV12(true);
			}
			if (catalog_version == DuckLakeVersion::V1_1_DEV_4 && options.automatic_migration) {
				metadata_manager.MigrateV13(true);
			}
			if (catalog_version == DuckLakeVersion::V1_1_DEV_5 && options.automatic_migration) {
				metadata_manager.MigrateV14(true);
			}
			if (catalog_version == DuckLakeVersion::V1_1_DEV_6 && options.automatic_migration) {
				metadata_manager.MigrateV15(true);
			}
			if (catalog_version >= target_version) {
			...
			if (catalog_version == DuckLakeVersion::V1_1_DEV_1 && catalog_version < target_version) {
				metadata_manager.MigrateV11();
				catalog_version = DuckLakeVersion::V1_1_DEV_2;
			}
			if (catalog_version == DuckLakeVersion::V1_1_DEV_2 && catalog_version < target_version) {
				metadata_manager.MigrateV12();
				catalog_version = DuckLakeVersion::V1_1_DEV_3;
			}
			if (catalog_version == DuckLakeVersion::V1_1_DEV_3 && catalog_version < target_version) {
				metadata_manager.MigrateV13();
				catalog_version = DuckLakeVersion::V1_1_DEV_4;
			}
			if (catalog_version == DuckLakeVersion::V1_1_DEV_4 && catalog_version < target_version) {
				metadata_manager.MigrateV14();
				catalog_version = DuckLakeVersion::V1_1_DEV_5;
			}
			if (catalog_version == DuckLakeVersion::V1_1_DEV_5 && catalog_version < target_version) {
				metadata_manager.MigrateV15();
				catalog_version = DuckLakeVersion::V1_1_DEV_6;
			}
			if (catalog_version != DUCKLAKE_LATEST_VERSION && catalog_version < target_version) {
...
void DuckLakeInitializer::SetVersionedMetadataManager(DuckLakeTransaction &transaction, DuckLakeVersion version) {
	...
	if (version >= DuckLakeVersion::V1_1_DEV_1 && version <= DuckLakeVersion::V1_1_DEV_6) {
