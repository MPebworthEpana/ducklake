...
public:
	...
	//! Whether formal type / constraint / generated-column metadata tables exist (added in 1.1-dev6)
	bool SupportsFormalMetadata() const {
		return ducklake_version >= DuckLakeVersion::V1_1_DEV_6;
	}
